...
- Softening factor.
- Fixed timestep.
- Стартовая сцена: Солнце, 8 планет и Луна в реальном масштабе координат/скоростей.
- Эфемериды стартовой сцены: NASA/JPL Horizons, DE441, `2026-06-16 00:00:00 TDB`, barycentric vectors.
- Единицы стартовой сцены: расстояние - млн км, время - дни, масса - массы Солнца.
